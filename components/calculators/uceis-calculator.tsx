...
const uceisParameters: UCEISParameter[] = [
  {
    ...
    options: [
      { value: '0', label: '0 - Normal', description: 'Padrão vascular claro com arborização' },
      { value: '1', label: '1 - Parcialmente obscurecido', description: 'Padrão vascular parcialmente visível' },
      { value: '2', label: '2 - Completamente obscurecido', description: 'Padrão vascular não visível' }
    ]
  },
  {
    id: 'bleeding',
    ...
    options: [
      ...
      { value: '1', label: '1 - Mucosa com sangue na luz', description: 'Sangue visível na luz intestinal' },
      { value: '2', label: '2 - Sangramento leve ao toque', description: 'Sangramento quando tocado pelo endoscópio' },
      { value: '3', label: '3 - Sangramento espontâneo', description: 'Sangramento espontâneo à frente do endoscópio' }
    ]
  },
  {
    id: 'erosionsUlcers',
    ...
    options: [
      { value: '0', label: '0 - Ausente', description: 'Sem erosões ou úlceras' },
      { value: '1', label: '1 - Erosões', description: 'Defeito mucoso menor que 5mm' },
      { value: '2', label: '2 - Úlceras superficiais', description: 'Defeito mucoso ≥5mm, superficial' },
      { value: '3', label: '3 - Úlceras profundas', description: 'Úlceras escavadas e profundas' }
    ]
  }
]
...
export default function UCEISCalculator({ onSaveResult, darkMode = true }: UCEISCalculatorProps) {
  ...
  const resultComponent = isComplete ? (
    <div className="space-y-4">
      <CalculatorCard title="Resultado UCEIS">
        <div className="text-center space-y-4">
          ...
          <div className="bg-gray-800/50 rounded-lg p-4 text-left">
            <h4 className="text-white font-medium mb-2">Pontuação Detalhada:</h4>
      ...
      <CalculatorCard title="Sobre o UCEIS">
        <div className="bg-blue-900/20 border border-blue-700 rounded-lg p-4">
          <h3 className="text-blue-400 font-medium mb-2">Ulcerative Colitis Endoscopic Index of Severity</h3>
          <div className="text-sm text-gray-300 space-y-2">
            <p>• Índice validado para avaliação endoscópica da colite ulcerativa</p>
    ...
    >
      <div className="space-y-4">
        <CalculatorCard title="Parâmetros UCEIS">
          <div className="space-y-4">
            {uceisParameters.map((parameter) => (
              <CalculatorQuestion key={parameter.id} question={parameter.label} required>
                <Select 
                  value={scores[parameter.id]} 
                  onValueChange={(value) => handleScoreChange(parameter.id, value)}
                >
        ...
        <CalculatorCard title="Instruções">
          <div className="bg-blue-900/20 border border-blue-700 rounded-lg p-4">
            <h3 className="text-blue-400 font-medium mb-2">Como aplicar o UCEIS</h3>
            <div className="text-gray-300 text-sm space-y-2">
              ...
              <p>4. Classifique erosões e úlceras conforme tamanho e profundidade</p>
