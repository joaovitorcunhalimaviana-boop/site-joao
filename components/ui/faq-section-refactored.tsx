...
const faqData = [
  ...
  },
  {
    ...
    answer: "Você pode agendar sua consulta de várias formas: através do nosso sistema online 24h, por WhatsApp, telefone ou presencialmente. Oferecemos consultas presenciais, teleconsultas e visitas domiciliares para sua comodidade.",
  ...
  },
  {
    ...
    answer: "O tratamento de hemorroidas varia conforme o grau e sintomas. Dr. João Vitor Viana oferece desde tratamentos clínicos conservadores até procedimentos minimamente invasivos como ligadura elástica, e cirurgia quando necessário.",
    category: "tratamento",
  ...
  },
  {
    ...
    answer: "Sim! Oferecemos teleconsultas por videoconferência para consultas de retorno, orientações médicas, discussão de exames e acompanhamento de tratamentos. É uma opção prática e segura para quem não pode se deslocar ao consultório.",
    category: "consulta",
  ...
  },
  {
    ...
    answer: "O consultório está localizado em João Pessoa, Paraíba. Também realizamos visitas domiciliares e hospitalares para pacientes que não podem se deslocar. Entre em contato para mais informações sobre localização e horários.",
    category: "consulta",
  ...
  },
  {
    ...
    answer: "O tratamento da fissura anal pode ser clínico (pomadas, relaxantes musculares, mudanças na dieta) ou cirúrgico nos casos crônicos. Dr. João Vitor Viana avalia cada caso individualmente para definir a melhor abordagem terapêutica.",
    category: "tratamento",
  ...
  },
  {
    ...
    answer: "Sim, Dr. João Vitor Viana realiza colonoscopias para diagnóstico e rastreamento de doenças intestinais. O exame é fundamental para detectar pólipos, câncer colorretal e outras alterações do intestino grosso.",
    category: "tratamento",
  ...
  },
  {
    ...
    answer: "Para a consulta, traga seus exames anteriores, lista de medicamentos em uso, histórico médico familiar e suas principais queixas anotadas. Isso ajuda o Dr. João Vitor Viana a fazer uma avaliação mais completa e precisa.",
    category: "consulta",
  ...
  },
  {
    ...
    answer: "Os valores das consultas variam conforme o tipo de atendimento (presencial, teleconsulta, domiciliar). Entre em contato conosco para informações atualizadas sobre valores e formas de pagamento. Aceitamos diversos planos de saúde.",
    category: "agendamento",
    ...
    <CardBase variant="interactive" className="text-center">
      <div className="space-y-4">
        ...
        <p className={medicalStyles.text.secondary}>
          Entre em contato conosco para esclarecer suas dúvidas ou agendar sua consulta.
        </p>
