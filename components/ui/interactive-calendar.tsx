...
export function InteractiveCalendar({ onDateSelect, selectedDate, appointments }: CalendarWithPatientsProps) {
            ...
            <div className="space-y-3 max-h-96 overflow-y-auto">
              {selectedDateAppointments.length > 0 ? (
                selectedDateAppointments.map((appointment, index) => {
                  const isPast = new Date(selectedDateState) < new Date(new Date().toISOString().split('T')[0]);
