...
import { Shield, ShieldCheck, ShieldX, Smartphone, AlertTriangle, Settings, Trash2 } from 'lucide-react'
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  {status.setupAt ? new Date(status.setupAt).toLocaleDateString('pt-BR') : 'N/A'}
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  {status.lastUsed ? new Date(status.lastUsed).toLocaleDateString('pt-BR') : 'Nunca usado'}
                </p>
              </div>
            </div>
              ...
              <Dialog open={showDisableDialog} onOpenChange={setShowDisableDialog}>
                ...
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Isso removerá a proteção adicional da sua conta. Digite sua senha para confirmar.
                    </DialogDescription>
                  </DialogHeader>
                  <div className="space-y-4">
                    {error && (
