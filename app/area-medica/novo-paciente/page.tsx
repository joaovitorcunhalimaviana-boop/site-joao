...
export default function NovoPackiente() {
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
    ...
    // Formatação automática para telefone e WhatsApp
      ...
      setFormData(prev => ({ 
        ...prev, 
        insurance: { ...prev.insurance, type: value as 'particular' | 'unimed' | 'outro' }
      }))
      ...
      <main className="py-8">
        <div className="max-w-2xl mx-auto px-4">
          ...
          <Card className="bg-gray-900 border-gray-700">
            <CardHeader>
              <CardTitle className="text-white">Cadastro de Novo Paciente</CardTitle>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
               ...
               <div className="space-y-2">
                 <Label htmlFor="insuranceType" className="text-gray-300">Tipo de Plano</Label>
                 <select
                   id="insuranceType"
                   name="insuranceType"
