        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <Card className="bg-gray-900/50 border-gray-700">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-white">Rascunhos Salvos</CardTitle>
              <Mail className="h-4 w-4 text-blue-400" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-white">{savedDrafts.length}</div>
              <p className="text-xs text-gray-400">
                Newsletters em rascunho
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gray-900/50 border-gray-700">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-white">Últimos Envios</CardTitle>
              <Users className="h-4 w-4 text-blue-400" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-white">
                {isClient ? JSON.parse(localStorage.getItem('newsletter-history') || '[]').length : 0}
              </div>
              <p className="text-xs text-gray-400">
          ...
          <Card className="bg-gray-900/50 border-gray-700">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-white">Próximo Envio</CardTitle>
          ...
          <Card className="bg-gray-900/50 border-gray-700">
            ...
            <CardContent>
              <div className="space-y-4">
                {savedDrafts.slice(-5).reverse().map((draft: any) => (
                  <div key={draft.id} className="flex items-center justify-between p-4 border border-gray-600 rounded-lg bg-gray-800/30">
                    <div>
                      <h3 className="font-medium text-white">{draft.subject}</h3>
                      <p className="text-sm text-gray-400">
                        Salvo em {new Date(draft.createdAt).toLocaleDateString('pt-BR')}
                      </p>
                    </div>
                    <Button
          ...
          <CardContent>
            <div className="space-y-6 text-sm">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <p className="font-medium text-white text-base mb-2">Edite o Conteúdo</p>
                  <p className="text-gray-300 leading-relaxed">Personalize o assunto e adicione suas dicas de saúde da semana na aba "Editar".</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <p className="font-medium text-white text-base mb-2">Visualize o Resultado</p>
                  <p className="text-gray-300 leading-relaxed">Use a aba "Preview" para ver como a newsletter ficará para os pacientes.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <p className="font-medium text-white text-base mb-2">Selecione Destinatários</p>
                  <p className="text-gray-300 leading-relaxed">Na aba "Destinatários", escolha quais pacientes receberão a newsletter.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <p className="font-medium text-white text-base mb-2">Envie ou Salve</p>
                  <p className="text-gray-300 leading-relaxed">Clique em "Enviar Newsletter" para enviar imediatamente ou "Salvar Rascunho" para enviar depois.</p>
                </div>
              </div>
            </div>
          </CardContent>
