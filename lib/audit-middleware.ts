...
export class AuditMiddleware {
  ...
  static async logPatientOperation(
    ...
    try {
      ...
      console.error('❌ Erro no log de auditoria de paciente:', error)
    }
  }
  ...
  static async logAppointmentOperation(
    ...
    try {
      ...
      console.error('❌ Erro no log de auditoria de consulta:', error)
    }
  }
  ...
  static async logMedicalRecordOperation(
    ...
    try {
      ...
      console.error('❌ Erro no log de auditoria de prontuário:', error)
    }
  }
  ...
  static async logSystemOperation(
    ...
    try {
      ...
      console.error('❌ Erro no log de auditoria do sistema:', error)
    }
  }
  ...
  static async logSecurityEvent(
    ...
    try {
      ...
      console.error('❌ Erro no log de auditoria de segurança:', error)
    }
  }
  ...
  static async logBackupOperation(
    ...
    try {
      ...
      console.error('❌ Erro no log de auditoria de backup:', error)
    }
  }
